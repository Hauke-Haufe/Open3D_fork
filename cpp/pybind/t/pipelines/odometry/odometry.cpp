...
Colored Point Cloud Registration Revisited, ICCV, 2017.)",
    ...
    m_odometry.def("compute_residual_map",
                   &ComputeResidualMap,
                   py::call_guard<py::gil_scoped_release>(),
                   "source_rgbdimage"_a, "source_rgbdimage"_a, "source_to_target"_a,
                   "intrinsic"_a, "method"_a = Method::Hybrid,
                   "depth_scale"_a = 1000.0f, "depth_max"_a = 3.0f,
                   "depth_outlier_trunc"_a = 0.07f);

    m_odometry.def("rgbdm_odometry_multi_scale", 
               py::overload_cast<const t::geometry::RGBDMImage&,
                        const t::geometry::RGBDMImage&,
                        const core::Tensor&,
                        const core::Tensor&,
                        const float, const float,
                        const std::vector<OdometryConvergenceCriteria>&,
                        const Method, const OdometryLossParams&>(&RGBDMOdometryMultiScale),
                py::call_guard<py::gil_scoped_release>(), 
                "source"_a, "target"_a, "intrinsics"_a, 
                "init_source_to_target"_a = core::Tensor::Eye(4, core::Float64, core::Device("CPU:0")),
                "depth_scale"_a = 1000.0f, "depth_max"_a = 3.0f,
                "criteria_list"_a = std::vector<OdometryConvergenceCriteria>({10, 5, 3}),
                "method"_a = Method::PointToPlane, "params"_a = OdometryLossParams());
