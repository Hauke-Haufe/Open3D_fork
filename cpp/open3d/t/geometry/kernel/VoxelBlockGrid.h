...
void SemanticIntegrate(const open3d::core::Tensor& depth,
...
template <typename input_depth_t,
          ...
          typename weight_t,
          typename color_t>
void MaskedIntegrateCPU(const core::Tensor& depth,
                  const core::Tensor& color,
                  const core::Tensor& mask, 
                  const core::Tensor& block_indices,
                  const core::Tensor& block_keys,
...
template <typename input_depth_t,
            ...
            typename color_t, 
            typename label_t>
void SemanticIntegrateCPU(const open3d::core::Tensor& depth,
         const open3d::core::Tensor& color,
         const open3d::core::Tensor& label,
...
template <typename input_depth_t, typename input_color_t, typename tsdf_t>
void WeightMaskedIntegrateCPU(const core::Tensor& depth,
         const core::Tensor& color,
         const core::Tensor& weight_mask,
...
template <typename input_depth_t,
          ...
          typename weight_t,
          typename color_t>
void MaskedIntegrateCUDA(const core::Tensor& depth,
                  const core::Tensor& color,
                  const core::Tensor& mask, 
                  const core::Tensor& block_indices,
                  const core::Tensor& block_keys,
...
template <typename input_depth_t,
          typename input_color_t,
          typename tsdf_t>
void WeightMaskedIntegrateCUDA(const core::Tensor& depth,
         const core::Tensor& color,
         const core::Tensor& weight_mask,
         const core::Tensor& indices,
         const core::Tensor& block_keys,
...
template <typename input_depth_t,
          ...
          typename color_t, 
          typename label_t>
void SemanticIntegrateCUDA(const open3d::core::Tensor& depth,
         const open3d::core::Tensor& color,
         const open3d::core::Tensor& label,
         const open3d::core::Tensor& indices,
         const open3d::core::Tensor& block_keys,
