...
.. code-block:: bash
    ...
    wget https://github.com/isl-org/Open3D/releases/download/v0.19.0/open3d-app-0.19.0-Ubuntu.deb
...
.. code-block:: bash
    ...
    wget https://raw.githubusercontent.com/isl-org/Open3D/v0.19.0/examples/python/visualization/render_to_image.py
    # Build docker image
    ...
    # Install Open3D from the PyPI repositories
    RUN python3 -m pip install --no-cache-dir --upgrade pip && \
        python3 -m pip install --no-cache-dir --upgrade open3d==0.19.0
